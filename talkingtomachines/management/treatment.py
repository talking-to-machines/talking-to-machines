...
def simple_random_assignment_session(
    treatment_labels: List[str], session_id_list: List[Any]
) -> dict[int, str]:
...
def complete_random_assignment_session(
    treatment_labels: List[Any], session_id_list: List[Any]
) -> dict[int, str]:
...
def full_factorial_assignment_session(
    treatment_labels: List[List[str]], session_id_list: List[Any]
) -> dict[int, str]:
    ...
    return complete_random_assignment_session(
        treatment_label_combinations, session_id_list
    )
...
def manual_assignment_session(
    ...
    Args:
        agent_demographics (pd.DataFrame): A list of treatment labels.
